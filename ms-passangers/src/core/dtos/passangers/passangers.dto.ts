// src/core/dtos/passangers/create-passangers.dto.ts
...
export class CreatePassangersDTO {
  @IsNotEmpty()
  @IsString()
  name: string;
...
export class UpdatePassangersDTO extends PartialType(CreatePassangersDTO) {
  @IsOptional()
  @IsArray()
  @IsNumber({}, { each: true })
...
export class PassangersPaginatedResponseDto extends createPaginatedResponseDto(PassangersDto) { }
