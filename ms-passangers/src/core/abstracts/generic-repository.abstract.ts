...
import { FilterPaginationQuery } from "../dtos/pagination/paginateRequest.dto";
...
export abstract class IGenericRepository<T> {
   ...
   * @returns {Promise<T | null>} - The updated element or null
   */
  abstract findByIdAndUpdate(id: mongoose.Types.ObjectId | string, data: Partial<T>): Promise<T | null>;
   ...
   * @returns {Promise<T | null>} - The updated element or null
   */
  abstract findById(id: mongoose.Types.ObjectId): Promise<T | null>;
   ...
   * @returns {Promise<T | null>} - The updated element or null
   */
  abstract findByIdAndRemove(id: mongoose.Types.ObjectId): Promise<T | null>;
   ...
   */
  abstract count(filter: object): Promise<number>;
   ...
   * @returns {Promise<T>} Paginated list of elements that match the filter criteria
   */
  abstract aggregate(filter: any): Promise<T[]>;
}
